...
export const AUTOMOTIVE_THEME_DEFINITIONS: AutomotiveThemeDefinition[] = [
  {
    mode: 'dark',
    name: '100% Noir Pur',
    subtitle: 'Fond entièrement noir & écriture blanche haute lisibilité',
    bgHex: '#000000',
    cardBgHex: '#0c0c0e',
    accentHex: '#FFFFFF',
    badgeTag: 'Noir & Blanc',
  ...
  },
  {
    mode: 'light',
    name: '100% Blanc Pur',
    subtitle: 'Fond entièrement blanc & écriture noire haute netteté',
    bgHex: '#FFFFFF',
    cardBgHex: '#FFFFFF',
    accentHex: '#09090B',
    badgeTag: 'Blanc & Noir',
    ...
    gradientBg: 'from-white via-slate-50 to-white',
  },
  {
    mode: 'red',
    name: 'Chery Crimson',
