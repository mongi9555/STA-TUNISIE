                ...
                <div>
                  ...
                  >
                    ...
                    <div className="absolute top-3 left-3 flex items-center gap-1.5 flex-wrap max-w-[90%]">
                      ...
                      <span className="px-2 py-0.5 bg-red-600 text-white text-[11px] font-black rounded-lg shadow-md font-mono flex items-center gap-1 border border-red-400/40">
                        #{index + 1}
                        {sortBy.startsWith('price') && (
                          <span className="text-[10px] font-bold opacity-90">({fullPrice.toLocaleString()} DT)</span>
                        )}
                        {sortBy.startsWith('size') && (
                          <span className="text-[10px] font-bold opacity-90">({dims.lengthM} m)</span>
                        )}
                      </span>
                    ...
                    <div className="absolute bottom-3 left-4 right-4 flex items-end justify-between gap-2">
                      <div>
                        ...
                        <div className="flex items-center gap-1.5 text-[10px] text-blue-300 font-mono font-bold bg-slate-950/80 px-1.5 py-0.5 rounded border border-blue-500/30 mt-0.5 inline-flex">
                          <Ruler className="w-3 h-3 text-blue-400" />
                          <span>{dims.lengthM} m ({dims.lengthMm} mm)</span>
                        </div>
                      </div>
                  ...
                  <div className="p-4 space-y-3.5">
                    {/* Tech specs summary (Dimensions + Engine + Transmission) */}
                    ...
                    {/* Dimensions & Segment Pill */}
                    <div className="p-2.5 bg-blue-950/30 border border-blue-500/30 rounded-xl flex items-center justify-between text-xs">
                      <div className="flex items-center gap-2">
                        <Ruler className="w-4 h-4 text-blue-400 shrink-0" />
                        <div>
                          <div className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Dimensions &amp; Gabarit</div>
                          <div className="font-mono text-white font-bold text-xs">{dims.formatted}</div>
                        </div>
                      </div>
                      <span className="text-[10px] font-semibold text-blue-300 bg-blue-900/50 px-2 py-0.5 rounded border border-blue-400/30 shrink-0">
                        {dims.segmentLabel}
                      </span>
                    </div>
